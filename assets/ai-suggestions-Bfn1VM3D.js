const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/firebase-config-CPJ13vib.js","assets/firebase-config-DVv8XtdB.css","assets/main-DOZ5ZINl.js"])))=>i.map(i=>d[i]);
import{c as H,e as M,f as B,_ as T,r as D}from"./main-DOZ5ZINl.js";import"./firebase-config-CPJ13vib.js";function S(){const m=M();if(!m)return;const L=document.getElementById("ai-profile-container"),b=document.getElementById("ai-summary-text"),s=document.getElementById("refresh-ai-btn"),p=document.getElementById("ai-stats-grid");async function x(){if(!s)return;const d=s.innerHTML;s.disabled=!0,s.innerHTML='<i class="fas fa-sync fa-spin mr-2"></i> Synchronisation...';try{const a=await D(m.uid);a&&a.profile?await y(a.profile,a.debug,a):await y()}catch(a){console.error(a),alert("Erreur lors de la ré-analyse.")}finally{s.disabled=!1,s.innerHTML=d}}async function y(d=null,a=null,v=null){if(!L)return;const n=d||await B(m.uid);if(!n){L.innerHTML=`
